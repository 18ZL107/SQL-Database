...
<main>
    <?php 
        ...
        $LName = $_POST['LName'];
        $DOB = $_POST['Birthday'];
        $connection->query("INSERT INTO Patient(OHIP, FirstName, LastName, Birthday) VALUES('$OHIP', '$FName', '$LName', '$DOB')");

        echo "<div class = 'title'>You have now been registered! Please click the button to register your vaccination if you want!</div>";
    ?>
